...
for(spp in species_list) {
    ...
    names_ev <- c("bio1", "bio2", "bio4", "bio8", "bio12", "bio15", "elevation",
                  ...
                  "pyrome_consensus_1", "pyrome_consensus_2", "pyrome_consensus_3", 
                  "pyrome_consensus_4", "pyrome_consensus_5", "pyrome_consensus_6", 
                  "pyrome_consensus_7", "pyrome_consensus_8", "pyrome_consensus_9", 
                  "pyrome_consensus_10", "pyrome_consensus_11", "samp_bias")
...
for(u in species_list) {
    ...
    d_con <- db[db[, u] == 1, c(u, "pyrome_consensus_1", "pyrome_consensus_2",
                                "pyrome_consensus_3", "pyrome_consensus_4", "pyrome_consensus_5",
                                "pyrome_consensus_6", "pyrome_consensus_7", "pyrome_consensus_8",
                                "pyrome_consensus_9", "pyrome_consensus_10", "pyrome_consensus_11")]
